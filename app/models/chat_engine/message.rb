module ChatEngine
  class Message < ApplicationRecord
    ...
    validates :document, attached: true, content_type: { content_type: ["application/pdf", 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', "image/jpeg", "image/gif", "image/png", "image/jpg", "image/bmp"] }
